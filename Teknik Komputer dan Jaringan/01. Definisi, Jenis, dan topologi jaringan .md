...
<img width="656" height="472"  alt="kabel UTP" src="https://github.com/user-attachments/assets/c475ae1b-4643-444a-81b3-21bb7896d1f9" />

**a) Kabel Twisted Pair (UTP/STP)**
- Digunakan pada jaringan LAN.
- **UTP (Unshielded Twisted Pair):** tanpa pelindung tambahan.
- **STP (Shielded Twisted Pair):** dilengkapi pelindung untuk mengurangi gangguan.
- Contoh: Kabel LAN Cat5e, Cat6.
...
**b) Kabel Coaxial**
- Digunakan pada jaringan lama (topologi Bus).
- Memiliki satu konduktor pusat dengan pelindung luar.
- Contoh: jaringan TV kabel.

<img  width="656" height="472"  alt="Fo" src="https://github.com/user-attachments/assets/3e6b45fd-0cf3-417c-9ed0-f4069e154fc1" />

**c) Kabel Fiber Optic**
- Menggunakan serat kaca/plastik untuk mentransmisikan data berupa cahaya.
- Kecepatan sangat tinggi, stabil, jarak jauh.
- Cocok untuk backbone jaringan antar-gedung.
...
- Digunakan untuk laptop, smartphone, IoT.

**b) Bluetooth**
- Jarak dekat, kecepatan rendah.
- Untuk headset, printer, HP.

**c) Infrared**
- Teknologi lama, point-to-point.
- Contoh: remote TV.

**d) Gelombang Radio & Microwave**
- Untuk komunikasi jarak jauh.
- Contoh: 4G/5G, satelit, radio link antar BTS.
